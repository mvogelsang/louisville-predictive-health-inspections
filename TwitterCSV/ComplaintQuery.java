...
public class ComplaintQuery extends TimerTask {
	...
	public void run()
	{
		...
		{	
			...
			{
				//Write to csv file
				WritingToFile.CSVFile("C:/inetpub/la/ComplaintLog.csv", status.getText(), status.getUser().getScreenName(), status.getCreatedAt().toString(), tweetCleanup(status.getText()), "TWITTER");
